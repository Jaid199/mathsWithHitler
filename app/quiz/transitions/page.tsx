...
export default function TranslationQuizPage() {
  ...
  const questions: Question[] = [
    {
      ...
      // hint: "(¹):(¹):",
      grid: { pointA: { x: -2, y: 3 }, pointB: { x: 2, y: 1 } },
      options: ["(⁴/₁)", "(⁸/₁)", "(⁵/₂)", "(⁴/₂)"],
      displayOptions: ["(⁴/₁)", "(⁸/₁)", "(⁵/₂)", "(⁴/₂)"],
      correctAnswer: 2,
    },
    ...
    },
    {
      ...
      // hint: "(¹):(¹):",
      grid: { pointA: { x: -2, y: 4 }, pointB: { x: 1, y: 0 } },
      options: ["(⁴/₁)", "(⁸/₁)", "(²/₋₅)", "(⁴/₂)"],
      displayOptions: ["(⁴/₁)", "(⁸/₁)", "(²/₋₅)", "(⁴/₂)"],
      correctAnswer: 0,
    },
    ...
    },
    {
      ...
      // hint: "(¹):(¹):",
      grid: { pointA: { x: -1, y: 3 }, pointB: { x: 2, y: 1 } },
      options: ["(⁴/₁)", "(²/₋₂)", "(⁵/₂)", "(⁴/₂)"],
      displayOptions: ["(⁴/₁)", "(²/₋₂)", "(⁵/₂)", "(⁴/₂)"],
      correctAnswer: 1,
    },
  ...
  const calculateScore = () => {
    ...
    selectedAnswers.forEach((answer, index) => {
      if (index === 6) {
        // Check if draggable question is correct
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start justify-between">
              ...
              <div className="bg-white rounded-xl p-6 shadow-inner">
                <svg viewBox="0 0 300 240" className="w-full max-w-lg h-auto">
                  ...
                  {/* Interactive drop zones for question 7 */}
                  {currentQuestion === 6 && (
                    <>
                    ...
                    questions[currentQuestion].grid && (
                      <>
                        ...
                        <rect
                          x={
                            180 +
                            questions[currentQuestion].grid.pointA.x * 30 -
                            15
                          }
                          y={
                            110 -
                            questions[currentQuestion].grid.pointA.y * 30 -
                            15
                          }
                          width="30"
                          height="30"
                        ...
                        <text
                          x={
                            180 + questions[currentQuestion].grid.pointA.x * 30
                          }
                          y={
                            110 -
                            questions[currentQuestion].grid.pointA.y * 30 +
                        ...
                        <rect
                          x={
                            180 +
                            questions[currentQuestion].grid.pointB.x * 30 -
                            15
                          }
                          y={
                            110 -
                            questions[currentQuestion].grid.pointB.y * 30 -
                            15
                          }
                          width="30"
                          height="30"
                        ...
                        <text
                          x={
                            180 + questions[currentQuestion].grid.pointB.x * 30
                          }
                          y={
                            110 -
                            questions[currentQuestion].grid.pointB.y * 30 +
