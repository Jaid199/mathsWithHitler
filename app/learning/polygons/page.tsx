...
export default function PolygonsPage() {
  ...
  const slides = [
    ...
    },
    {
      ...
      polygon: 25,
      audio: "/auds/Icosikaipentagon.mp3",
    },
    {
      title: "Icosagon",
      sides: 20,
            ...
            <div className="flex-1 flex items-center gap-12">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <button
                    onClick={playAudio}
                    className="w-10 h-10 flex items-center justify-center bg-orange-400 hover:bg-orange-500 rounded-full transition-colors shadow-md"
